...
const MEDIA_BASE = isProduction
  ? 'https://demo.parkdistrictrec.com/wp-json/wp/v2/media'
 ...
 * Posts Endpoints *
 ******************/
const POSTS_BASE = isProduction
  ? 'https://demo.parkdistrictrec.com/wp-json/wp/v2/posts'
  : process.env.NEXT_PUBLIC_WP_REST_POST_URL;
 ...
 * Pages Endpoints *
 ******************/
const PAGES_BASE = isProduction
  ? 'https://demo.parkdistrictrec.com/wp-json/wp/v2/pages'
  : process.env.NEXT_PUBLIC_WP_REST_PAGES_URL;
 ...
 * Menus Endpoints *
 ******************/
const MENUS_URL = isProduction
  ? 'https://demo.parkdistrictrec.com/wp-json/headless/v1/menus'
  : process.env.NEXT_PUBLIC_WP_MENUS_URL;
